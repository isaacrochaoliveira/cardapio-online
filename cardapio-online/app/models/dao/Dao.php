...
class Dao extends Model{    
    ...
    public function selected($sql, $eh_lista=true) {
        return $this->select($this->db, $sql, $eh_lista);
    }

    public function lista($tabelaFrom, $tabelaTo=null, $campoFrom=null, $campoTo=null){
        return  $this->all($this->db, $tabelaFrom, $tabelaTo, $campoFrom, $campoTo);
    }    
    
    public function get($tabela, $campo=[], $valor=[], $eh_lista=true){
